        ...
        <div>
          ...
          <form className="flex flex-col space-y-2">
            <input
              ...
              className="px-3 py-2 border rounded text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400"
            />
            <button
              type="submit"
              className="bg-black text-white py-2 text-sm rounded hover:bg-gray-800 transition"
            >
              Sign Up
            </button>
          </form>
